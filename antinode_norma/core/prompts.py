...
FEATURE_GENERATION_EXAMPLES = [{"role": "registered user",
                                "action": "reset password via email",
                                "benefit": "regain access to my account",
                                "acceptance_criteria": ["The system sends a password reset link to the registered email.",
                               ...
                               {"role": "online shopper",
                                ...
                                "acceptance_criteria": ["The cart summary is displayed with item prices.",
                               ...
                               {"role": "guest shopper",
                                ...
                                "acceptance_criteria": ["The search bar accepts keywords.",
